...
{
    fstream file;
    file.open("F:\\OOP Program\\After Git Hub\\task.dat",ios::binary|ios::out);
    if(!file)
    {
    ...
    file.close();
    file.open("F:\\OOP Program\\After Git Hub\\task.dat",ios::binary|ios::in);
    if(!file)
    {
...
{  
  ...
  {
    file.open("F:\\OOP Program\\After Git Hub\\task.dat",ios::binary|ios::in|ios::out);
    if(!file)
    {
        cout<<"Error in opening of file please check file path and run again \n ";
    }
...
employee emp[n]={
                 ...
                 strcpy(emp[0].emp_name,"Muhammad Tayyab");
                 strcpy(emp[1].emp_name,"Muhammad Fahad");
                 strcpy(emp[2].emp_name,"Muhammad Mohsin");
                 strcpy(emp[3].emp_name,"Muhammad Aftab");
                 strcpy(emp[4].emp_name,"Muhammad Khizar");
...
else
{
 ...
 void del(fstream &file)
 {
    ...
    cin>>id;
    temp.open("F:\\OOP Program\\After Git Hub\\temp.dat",ios::binary|ios::out);
    if(!temp)
    {
    ...
    if(found)
    {
        file.close();
        temp.close();
        remove("F:\\OOP Program\\After Git Hub\\task.dat");
        rename("F:\\OOP Program\\After Git Hub\\temp.dat","F:\\OOP Program\\After Git Hub\\task.dat");
